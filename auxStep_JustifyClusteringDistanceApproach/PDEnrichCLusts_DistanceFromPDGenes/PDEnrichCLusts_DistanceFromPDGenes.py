...
if Flag:    
    ...
    for CC in range(len(cell_conds)): 
        ...
        if 'PINK1' in cell_cond:
            ...
            PD_genes_erichclsts = []
            with open(f'input/Clusters/{cell_cond}/kMeans_PDEnrichClusts.pkl', 'rb') as handle:
            ...
            for clst in range(len(ClustsPDEnrich)):
                ...
                for gene in EnrClust:
                    if gene in PD_genes:
                        PD_genes_erichclsts.append(gene)
            ...
            for gene in G1_OtherGenes.index.to_list():
                ...
                for genePD in PD_genes_erichclsts: #PD_genes_cc
